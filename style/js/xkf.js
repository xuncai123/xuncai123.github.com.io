...
!function (a, n) { "function" == typeof define && define.amd ? define(n) : "object" == typeof exports ? module.exports = n(require, exports, module) : a.CountUp = n() }(this, function (a, n, t) {
    var e = function (a, n, t, e, i, r) {
     ...
     $(function(){
        $(".partners ul li").mouseenter( function(){ $(this).find("img").css({"transition":"0.5s","transform":"rotateY(180deg)"}) } )
        $(".partners ul li").mouseleave( function(){ $(this).find("img").css({"transition":"0s","transform":"rotateY(360deg)"}) } )
    });
